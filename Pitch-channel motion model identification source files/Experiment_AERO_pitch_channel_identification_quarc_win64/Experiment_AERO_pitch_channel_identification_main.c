 ...
 * External functions *
 *====================*/
EXTERN RT_MODEL * Experiment_AERO_pitch_channel_identification(void);
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://Experiment_AERO_pitch_channel_identification:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Experiment_AERO_pitch_channel_identification -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  S = Experiment_AERO_pitch_channel_identification();
  if (rtmGetErrorStatus(S) != NULL) {
